...
* **Folder & File Data**: Sistem akan otomatis membuat direktori("data") dan File("txt") ketika program dijalankan(jika belum ada pada environment) melalui method(`loadData()`).
